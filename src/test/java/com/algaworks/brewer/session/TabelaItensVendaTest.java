...
public class TabelaItensVendaTest {
	...
	@Test
	public void testDeveCalcularValorTotalSemItens() {
		assertEquals(BigDecimal.ZERO, tabelaItensVenda.getValorTotal());
	}
	
	@Test
	public void testDeveCalcularValorTotalComUmItem() {
	...
	@Test
	public void testDeveCalcularValorTotalComVariosItens() {
	...
	@Test
	public void testDeveManterTamanhoDaListParaCervejasIguais() {
		Cerveja c1 = new Cerveja();
		c1.setCodigo(1L);
	...
	@Test
	public void testDeveAlterarQuantidadeItem() {
		Cerveja c1 = new Cerveja();
		c1.setCodigo(1L);
		c1.setValor(new BigDecimal("4.50"));
	...
	@Test
	public void testDeveExcluirItem() {
		Cerveja c1 = new Cerveja();
		c1.setCodigo(1L);
